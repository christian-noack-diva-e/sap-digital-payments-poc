...
inputFiles = [
    ...
    [file: 'backend/README.adoc', formats: ['html']],
    [file: 'frontend/README.adoc', formats: ['html']],
    [file: 'sapdp_api_doc/README.adoc', formats: ['html']],
	/** inputFiles **/
]
...
confluence.with {
    input = [
        [ file: "build/html5/index.html", ancestorId: "6480593073" ],
    ]
    ...
    */
    credentials = "".bytes.encodeBase64().toString()
